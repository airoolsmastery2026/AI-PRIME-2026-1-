...
export const AIContentCoach: React.FC = () => {
    ...
    const promptIndices = [1, 2, 3, 4, 5, 6, 7, 8];
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="flex-grow overflow-y-auto pr-2">
                ...
                <CoachSection title={t('aiContentCoach.prompts.title')}>
                    <p>{t('aiContentCoach.prompts.description')}</p>
                    <div className="space-y-4 mt-4">
                        {promptIndices.map(i => (
                            <TrainingCommandBlock
                                key={i}
                                title={t(`aiContentCoach.prompts.p${i}.title`)}
                                command={t(`aiContentCoach.prompts.p${i}.command`)}
                            />
                        ))}
                    </div>
                </CoachSection>
